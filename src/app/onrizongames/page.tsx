            ...
            <main>
                <section className="scrollbar-wrapper" id="section">
                    ...
                    <div className="card-container">
                        <Link className="card" id="wos" href="https://wos.gg" target="_blank" rel="noopener">
                        ...
                        <Link className="card" id="gos" href="https://gos.gg" target="_blank" rel="noopener">
                            <div className="img-wrapper">
                        ...
                        <Link className="card" id="gs" href="https://gartic.show/" target="_blank" rel="noopener">
                            <div className="img-wrapper">
                        ...
                        <Link className="card" id="gp" href="https://garticphone.com/" target="_blank" rel="noopener">
                            <div className="img-wrapper">
                        ...
                        <Link className="card" id="sp" href="https://streampairs.com/" target="_blank" rel="noopener">
                            <div className="img-wrapper">
                        ...
                        <Link className="card" id="es" href="https://emotesearch.com/" target="_blank" rel="noopener">
                            <div className="img-wrapper">
                        ...
                        <Link className="card" id="std" href="https://savethedeal.gg/" target="_blank" rel="noopener">
                            <div className="img-wrapper">
                        ...
                        <Link className="card" id="ss" href="https://stopots.com/" target="_blank" rel="noopener">
                            <div className="img-wrapper">
